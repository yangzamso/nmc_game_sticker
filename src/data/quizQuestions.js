...
export const QUIZ_GROUPS = [
  {
    ...
    variants: [
      {
        type: 'choice',
        question: '다음 중 2025년 8월~2026년 7월까지 새롭게 등장한 캐릭터가 아닌 것은?',
        options: ['하얀늑대', '아담', '탐정', '아저씨'],
        answerIndex: 3,
      },
      {
        type: 'choice',
        question: '다음 중 2025년 8월~2026년 7월까지 새롭게 등장한 캐릭터는?',
  ...
  },
  {
    ...
    variants: [
      ...
      },
      {
        ...
        options: ['에이티즈 - BAD', '태양 - Live fast die slow', 'CORTIS - RED RED', 'BTS - SWIM'],
        answerIndex: 3,
      },
    ],
  },
  {
    ...
    variants: [
      {
        type: 'text',
        question: '다음 빈칸을 채우시오. Stay Close 간주 중에 하는 응원법 구호 9글자',
        excerpt: 'ㅁㅁ 밭 길 위에 ㅁ을 춰',
        blanks: ['가시', '춤'],
      },
      {
        type: 'text',
        question: 'Stay Close 갤럭시 키즈 앨범 소개 글',
        excerpt: '20살 머큐리와 21살 주피터, ㅁㅁ에서 ㅁㅁ으로 가는 길목 어딘가',
        blanks: ['소년', '어른'],
      },
      {
        type: 'text',
        question: '닛몰캐쉬가 금연 실패 후 금연하시는 분들에게 남긴 한마디는?',
        excerpt: 'ㅁㅁ은 시작도 하지 마십쇼',
        blanks: ['흡연'],
      },
    ],
  },
